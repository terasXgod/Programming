...
public class RemoveLowerCommand implements Command {
    ...
    /**
     * Removes all vehicles whose ids are lower than the provided vehicle's id.
     *
    ...
    public String execute(CollectionManager collectionManager) {
        ...
        int id = target.getId() == null ? Integer.MIN_VALUE : target.getId();
        int removed = 0;
